export default function SvgBodyText({size}){
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fillRule="currentColor" className="bi bi-body-text" viewBox="0 0 16 16">
