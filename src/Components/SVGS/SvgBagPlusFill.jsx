export default function SvgBagPlusFill({size}){

    return(
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fillRule="currentColor" className="bi bi-bag-plus-fill" viewBox="0 0 16 16">
